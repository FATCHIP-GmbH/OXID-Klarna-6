        ...
        if ($this->isKlarnaOrder() && $notCancelled && $inSync) {
            ...
            if ($discountChanged) {
                if ($captured) {
                    ...
                    oxRegistry::get('oxUtilsView')->addErrorToDisplay(sprintf(
                        $oLang->translateString('KL_ORDER_UPDATE_CANT_BE_SENT_TO_KLARNA'), $reason));
                ...
                $oOrder->updateKlarnaOrder($orderLines, $klorderid, $sCountryISO);
            }
            ...
            if ((int)$edit['oxorder__oxordernr'] !== $oldOrderNum) {
                ...
                try {
                    ...
                    oxRegistry::get('oxUtilsView')->addErrorToDisplay(sprintf(
                        $oLang->translateString('KL_ORDER_UPDATE_CANT_BE_SENT_TO_KLARNA'), $e->getMessage()));
                }
            }
