...
class NavigationFrontendTest extends AcceptanceTestCase
{
     ...
     * @throws \Exception
     */
    public function testFrontendOrder()
    {
        ...
        //login
        $this->click("//div[@id='klarnaLoginWidget']");
        $this->type("//div[@id='klarnaLoginWidget']//input[@name='lgn_usr']", "user@oxid-esales.com");
        $this->type("//div[@id='klarnaLoginWidget']//input[@name='lgn_pwd']", "12345");
        $this->clickAndWait("//div[@id='loginBox']//button[@type='submit']");

        $this->selectFrame('klarna-checkout-iframe');
        $this->type("//fieldset[@id='challenge-fieldset']//input[@name='email']","ferreira@topconcepts.com");
        $this->type("//fieldset[@id='challenge-fieldset']//input[@name='postal-code']","10115");
//        $this->type("//fieldset[@id='klarna-checkout-billing-address']//input[@name='billing_address.phone']","123456789");


        $this->clickAndWait("//fieldset[@id='challenge-fieldset']//button");
    }
