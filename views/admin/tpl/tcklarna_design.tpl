...
<script src="[{ $oViewConf->getModuleUrl('klarna', 'out/src/js/libs/jscolor/jscolor.js') }]"></script>
...
<script src="[{ $oViewConf->getModuleUrl('klarna', 'out/admin/src/js/tcklarna_design.js') }]"></script>
