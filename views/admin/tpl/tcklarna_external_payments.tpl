...
<script type="text/javascript" src="[{ $oViewConf->getModuleUrl('klarna', 'out/src/js/libs/tooltipster.bundle.min.js') }]"></script>
...
<div class="[{$box|default:'box'}]" style="[{if !$box && !$bottom_buttons}]height: 100%;[{/if}]">
    <div class="main-container">
        ...
        <div class="klarna-expandable-list">
            ...
            <script src="[{ $oViewConf->getModuleUrl('klarna', 'out/admin/src/js/tcklarna_external_payments.js') }]"></script>
        </div>
        [{ else }]
