...
<div class="[{$box|default:'box'}]" style="[{if !$box && !$bottom_buttons}]height: 100%;[{/if}]">
    <div class="start_ext_version">
        <img src="[{ $oViewConf->getModuleUrl('klarna', 'out/admin/src/img/checked_checkbox_green_35.png') }]"> [{$oView->getKlarnaModuleInfo()}]
    </div>
    ...
    <div class="start_user_guide">
        <div class="user-guide-img">
            <img src="[{ $oViewConf->getModuleUrl('klarna', 'out/admin/src/img/user-guide-icon.png') }]" height="60px" width="60px">
        </div>
