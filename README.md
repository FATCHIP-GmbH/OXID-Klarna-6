...
In the shop's main folder ( the one with composer.json file) run this command:
  ...
  composer require topconcepts/oxid-klarna-6:v5.1.1

or add the following line within the "require" section to your composer.json file:

  "topconcepts/oxid-klarna-6": "v5.1.1"
...
### In English: https://www.cgrd.de/customer/klarna/docs/klarna-module-for-oxid-en-5.1.1.pdf
### In German: https://www.cgrd.de/customer/klarna/docs/klarna-module-for-oxid-de-5.1.1.pdf
